                                     ...
                                     ble_radio_notification_evt_handler_t evt_handler)
{
    ...
    // Configure the event - disable since we don't want the main loop to run 
    // every time the radio turns on/off
    return sd_radio_notification_cfg_set(NRF_RADIO_NOTIFICATION_TYPE_NONE, distance);
}
