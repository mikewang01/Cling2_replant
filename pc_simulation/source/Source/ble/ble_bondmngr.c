...
#define MAX_BONDS_IN_FLASH           3                                                                   /**< Maximum number of bonds that can be stored in flash. */
...
static uint32_t on_auth_status_from_new_central(ble_gap_evt_auth_status_t * p_auth_status)
{
    ...
    {
        ble_bondmngr_bonded_centrals_delete();
    }
...
uint32_t ble_bondmngr_init(const ble_bondmngr_init_t * p_init)
{
